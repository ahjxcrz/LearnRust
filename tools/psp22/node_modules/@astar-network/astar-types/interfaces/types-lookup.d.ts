declare module '@polkadot/types/lookup' {
    ...
    interface PalletSystemCall extends Enum {
    ...
    interface PalletSystemError extends Enum {
    ...
    interface PalletSystemEvent extends Enum {
    ...
    interface PalletEthCallCall extends Enum {
    ...
    interface PalletParachainSystemError extends Enum {
    ...
    interface PalletParachainSystemEvent extends Enum {
    ...
    type PalletCumulusXcmCall = Null;
    /** @name PalletCumulusXcmEvent (127) */
    interface PalletCumulusXcmEvent extends Enum {
